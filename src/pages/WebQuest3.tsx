...
function VideoStep() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Task II: True or False</h4>
...
function IdiomsStep() {
  return (<>
    <h4 className="font-display text-base font-semibold mb-2">Task III: Match cultural idioms with meanings</h4>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Task IV: Idioms and Stereotypes</h4>
...
function VocabularyStep() {
  return (<>
    <h4 className="font-display text-base font-semibold mb-2">Task V: Fill in the Gaps</h4>
...
function ReadingStepContent() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Comprehension: Choose correct answer</h4>
...
function ObservationsStep() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Task III: True, False, or Depends?</h4>
      <TrueFalseTask statements={[
