        ...
        <div className="flex flex-1 overflow-hidden">
          <aside className="hidden md:flex flex-col w-52 shrink-0 border-r-2 bg-card/70 backdrop-blur-md h-full overflow-y-auto py-1 px-1 gap-px"
            ...
            <div className="px-1.5 pb-1 mb-0.5 border-b border-border/50">
              ...
              <span className="text-[9px] font-body font-medium uppercase tracking-widest text-quest-gold">Module 2</span>
              <h1 className="font-display text-sm font-bold leading-tight">🌍 WebQuest 3 — Cultural Stereotypes</h1>
            </div>
            {steps.map((s, i) => {
              const Icon = s.icon;
                  ...
                  {steps.map((s, i) => {
                    ...
                    return (
                      <button key={s.id} onClick={() => goTo(i)}
                        ...
                        <Icon className="w-4 h-4 shrink-0" /><span>{s.label}</span>
                      </button>
                    );
                  })}
                </motion.aside>
          ...
          <main className="flex-1 min-w-0 overflow-y-auto">
            <div className="md:hidden sticky top-0 z-30 bg-card/70 backdrop-blur-md border-b border-border/50">
              <div className="flex items-center gap-2 px-3 pt-2 pb-1">
                ...
                <span className="text-[9px] font-body font-medium uppercase tracking-widest text-quest-gold">Module 2</span>
                <span className="font-display text-xs font-bold truncate">🌍 WQ 3 — Cultural Stereotypes</span>
              </div>
...
function InfographicStep() {
  return <img src="/images/webquest3/infographic2.jpg" alt="WebQuest 3 Infographic — Cultural Stereotypes" loading="lazy" className="rounded-xl w-full object-contain shadow-lg" />;
}
...
function VideoStep() {
  return (
    <>
      ...
      <div className="mt-4">
        <OpenQuestionTask title="Task I: Video Questions" questions={[
      ...
      <div className="mt-4">
        <h4 className="font-display text-sm font-semibold mb-2">Task II: True or False</h4>
...
function IdiomsStep() {
  return (
    <>
      <h4 className="font-display text-sm font-semibold mb-2">Task III: Match cultural idioms with meanings</h4>
      <SelectMatchingTask
        pairs={[
      ...
      />
      <div className="mt-4">
        <h4 className="font-display text-sm font-semibold mb-2">Task IV: Idioms and Stereotypes</h4>
        <SelectMatchingTask
          pairs={[
...
function VocabularyStep() {
  return (
    <>
      <h4 className="font-display text-sm font-semibold mb-2">Task V: Fill in the Gaps</h4>
      <FillBlanksTask
  ...
  return (
    <>
      ...
      <ReadingSection title="Why do stereotypes exist?">
        Because stereotypes are standardized and simplified ideas based on prejudices, they are not derived from objective facts. As Sociologist Charles E. Hurst states: "One reason for stereotypes is the lack of personal familiarity."
      </ReadingSection>
      <ReadingSection title="Impact of stereotypes">
        Stereotypes may affect people negatively: forming inaccurate images, scapegoating, making erroneous judgments. They can lead to xenophobic or racist behavior.
      </ReadingSection>
      <div className="mt-4">
        <h4 className="font-display text-sm font-semibold mb-2">Comprehension: Choose correct answer</h4>
...
function ObservationsStep() {
  return (
    <>
      <h4 className="font-display text-sm font-semibold mb-2">Task I: Cultural Observations</h4>
      ...
      <h4 className="font-display text-sm font-semibold mb-2">Task II: Match situation with cultural meaning</h4>
      <SelectMatchingTask
        pairs={[
      ...
      />
      <div className="mt-4">
        <h4 className="font-display text-sm font-semibold mb-2">Task III: True, False, or Depends?</h4>
        <TrueFalseTask statements={[
...
function ResearchStep() {
  return (
    <>
      ...
      <OpenQuestionTask title="Research & Write" questions={[
