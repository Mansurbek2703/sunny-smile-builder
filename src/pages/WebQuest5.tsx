        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <AnimatePresence>{mobileMenuOpen && (<>
            ...
            <motion.aside initial={{ x: -280 }} animate={{ x: 0 }} exit={{ x: -280 }} transition={{ type: "spring", damping: 25, stiffness: 300 }} className="fixed left-0 top-0 bottom-0 w-72 bg-card border-r z-50 md:hidden overflow-y-auto py-4 px-3">
              ...
              {steps.map((s, i) => { const Icon = s.icon; const active = i === currentStep; return (<button key={s.id} onClick={() => goTo(i)} className={`flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-left transition-colors text-base font-body mb-1 ${active ? "bg-primary text-primary-foreground font-semibold" : "hover:bg-muted text-muted-foreground"}`}><Icon className="w-4 h-4 shrink-0" /><span>{s.label}</span></button>); })}
...
function VocabularyStep() {
  return (<>
    <h4 className="font-display text-base font-semibold mb-2">Match the terms with definitions</h4>
...
function ReadingStep() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Match headings to paragraphs</h4>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Match terms with descriptions</h4>
...
function EtiquetteStep() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">True or False</h4>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Match words with meanings</h4>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Fill in the blanks</h4>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Match Culture with Etiquette Rule</h4>
...
function VideoStep() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Choose the correct answer</h4>
