...
const WebQuest5 = () => {
  ...
  useResponseTracker(5, steps, currentStep);
...
function StepContent({ stepId }: { stepId: string }) {
  switch (stepId) {
    case "infographic": return <img src="/images/webquest5/infographic1.webp" alt="WebQuest 5 — Culture Shock Infographic" loading="eager" decoding="async" className="rounded-xl w-full object-contain shadow-lg" />;
...
function IntroStep() {
  return (<>
    ...
    <img src="/images/webquest5/intro_culture.webp" alt="Culture Shock and Etiquette Around the World" loading="eager" decoding="async" className="w-full max-h-[350px] object-cover rounded-xl shadow-md mx-auto mb-2" />
