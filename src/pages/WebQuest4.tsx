        ...
        <div className="flex flex-1 overflow-hidden">
          <aside className="hidden md:flex flex-col w-56 shrink-0 border-r-2 bg-card/70 backdrop-blur-md h-full overflow-y-auto py-1 px-1 gap-px" style={{ borderImage: 'linear-gradient(to bottom, hsl(var(--quest-sky)), hsl(var(--quest-gold)), hsl(var(--quest-emerald))) 1' }}>
            <div className="px-1.5 pb-1 mb-0.5 border-b border-border/50">
              ...
              <h1 className="font-display text-base font-bold leading-tight">🌍 WebQuest 4 — City Through Tourist Eyes</h1>
            </div>
          ...
          <main className="flex-1 min-w-0 overflow-y-auto">
            <div className="md:hidden sticky top-0 z-30 bg-card/70 backdrop-blur-md border-b border-border/50">
              <div className="flex items-center gap-2 px-3 pt-2 pb-1"><Link to="/" className="text-muted-foreground hover:text-foreground"><ArrowLeft className="w-4 h-4" /></Link><span className="text-[11px] font-body font-medium uppercase tracking-widest text-quest-gold">Module 3</span><span className="font-display text-sm font-bold truncate">🌍 WQ 4 — City Through Tourist Eyes</span></div>
...
function IdiomsStep() {
  return (<>
    <h4 className="font-display text-base font-semibold mb-2">Task II — Match Travel Idioms with Meanings</h4>
...
function ReadingStepContent() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Task III: True or False</h4>
