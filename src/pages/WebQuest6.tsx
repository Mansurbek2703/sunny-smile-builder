        ...
        <div className="flex flex-1 overflow-hidden">
          <aside className="hidden md:flex flex-col w-56 shrink-0 border-r-2 bg-card/70 backdrop-blur-md h-full overflow-y-auto py-1 px-1 gap-px" style={{ borderImage: 'linear-gradient(to bottom, hsl(var(--quest-sky)), hsl(var(--quest-gold)), hsl(var(--quest-emerald))) 1' }}>
            <div className="px-1.5 pb-1 mb-0.5 border-b border-border/50">
              ...
              <h1 className="font-display text-base font-bold leading-tight">🍽️ WebQuest 6 — Food Culture & Dining</h1>
            </div>
...
function VideoStep() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Task A: Match country with dining rule</h4>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Task C: Choose the correct option</h4>
...
function Reading1Step() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">Choose the right answer</h4>
...
function Reading2Step() {
  return (<>
    ...
    <div className="mt-4">
      <h4 className="font-display text-base font-semibold mb-2">True, False, or Culture-dependent?</h4>
